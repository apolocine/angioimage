...
public class PersonInfoEntryTreeUI extends JFrame {

	
	
	private PersonDAO personDAO; // Ajouter l'instance de PersonDAO
   
   private PhotoOrganizerTreeApp photoOrganizerApp;
...
//    private JButton enregistrerButton;
    ...
    public PersonInfoEntryTreeUI(PhotoOrganizerTreeApp photoOrganizerApp) {
